    ...
    return (
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
        ...
        <div className="flex items-center space-x-2 text-sm">
          ...
          <span>2025 CodeIQ. All rights reserved.</span>
        </div>

        {/* Right: Contact Icons */}
        <div className="flex items-center space-x-6">
          <a
            href="https://wa.me/919172929685"
            target="_blank"
          ...
          {/* GitHub */}
          <a
            href="https://github.com/bestcoder22"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* LinkedIn */}
          <a
            href="https://linkedin.com/in/soham-amrutkar/"
            target="_blank"
            rel="noopener noreferrer"
